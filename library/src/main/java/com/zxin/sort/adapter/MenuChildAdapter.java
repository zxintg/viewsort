...
public class MenuChildAdapter extends BaseAdapter {
	...
	public MenuChildAdapter(Context context, List<MenuEntity> list, boolean isEdit2,DragTipListener listener) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		viewHodler.deleteImg.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				if (!menuEntity.isSelect()&&listener!=null) {
					listener.addMenu(menuEntity);
				}
			}
		});
